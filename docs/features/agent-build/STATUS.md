...
| Janitor | `spec-001-janitor.md` | 3 (review loop) | 🟡 built + gate-green (5 commits; orchestrator-verified PASS; CH live smoke OK `HAYS PLC→02150950`; bullhorn CLI bridge 31/31) — review sub-agent + Codex in flight | `worktree-agent-abb2ffb971bb471ba` | partial — Companies House SMOKED live; **Bullhorn BLOCKED** (`write_state:deferred` honest rows) |
| Scribe | `spec-002-scribe.md` | 3 (review loop) | 🟡 built + gate-green (5 commits; orchestrator-verified PASS; Granola-only vendor honoured; bh-bridge shim documented) — review sub-agent + Codex in flight | `worktree-agent-a59f16e915e384257` | no — **Bullhorn BLOCKED** + Granola token/0-meetings |
