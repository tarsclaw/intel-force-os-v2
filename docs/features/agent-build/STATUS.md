...
| Concierge | `spec-004-concierge.md` | 4 | 🔨 implementing — worktree sub-agent in flight (owns autosend-bridge-telegram production wiring; Bullhorn via local shim) | TBC on report | no — Bullhorn + email OAuth; Telegram cred state verified by worker |
