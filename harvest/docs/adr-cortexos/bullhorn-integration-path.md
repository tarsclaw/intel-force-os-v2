...
**Status:** **Sub-decision A RESOLVED 2026-06-02** — marketplace partner programme deferred to v1.1+; direct API per-tenant OAuth is the v1.0 path. Sub-decision C remains Accepted technically. Sub-decision B in flight with Bullhorn developer-support team via the `developer.bullhorn.com` route (founder submitted 2026-06-02).
**Author:** Claude Code, founder commercial verification complete for A; B in flight
